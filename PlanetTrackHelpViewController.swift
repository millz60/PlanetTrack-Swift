...
class PlanetTrackHelpViewController: UIViewController {
    ...
    private func setupTutorial() {
        ...
        let tutorialOverlay = UIImageView(frame: CGRect(x: self.tutorialView.frame.size.width - 200, y: self.tutorialView.frame.size.height - 75, width: 300, height: 175))
        
        tutorialOverlay.image = UIImage(named: "tutorial1")
        self.view.addSubview(tutorialOverlay)
        
        let tutorialText1 = UILabel(frame: CGRect(x: self.tutorialView.frame.size.width + 125, y: 50, width: 350, height: 35))
        tutorialText1.layer.zPosition = 9999
        tutorialText1.font = UIFont(name: "Avenir Next Condensed Demi Bold", size: 22.0)
        tutorialText1.text = "Select the planet you want to change"
        tutorialText1.textColor = UIColor.whiteColor()
        tutorialText1.alpha = 0.0
        
        let tutorialText2 = UILabel(frame: CGRect(x: self.tutorialView.frame.size.width + 125, y: 85, width: 350, height: 35))
        tutorialText2.layer.zPosition = 9999
        tutorialText2.font = UIFont(name: "Avenir Next Condensed Demi Bold", size: 22.0)
        ...
        let tutorialText3 = UILabel(frame: CGRect(x: self.tutorialView.frame.size.width + 125, y: 120, width: 350, height: 35))
        tutorialText3.layer.zPosition = 9999
        tutorialText3.font = UIFont(name: "Avenir Next Condensed Demi Bold", size: 22.0)
        tutorialText3.text = "Select the destination planet"
        tutorialText3.textColor = UIColor.whiteColor()
        tutorialText3.alpha = 0.0

        
        let tutorialText4 = UILabel(frame: CGRect(x: self.tutorialView.frame.size.width + 125, y: 155, width: 350, height: 35))
        tutorialText4.layer.zPosition = 9999
        tutorialText4.font = UIFont(name: "Avenir Next Condensed Demi Bold", size: 22.0)
        ...
        let tutorialText5 = UILabel(frame: CGRect(x: self.tutorialView.frame.size.width + 125, y: 190, width: 350, height: 35))
        tutorialText5.layer.zPosition = 9999
        tutorialText5.font = UIFont(name: "Avenir Next Condensed Demi Bold", size: 22.0)
